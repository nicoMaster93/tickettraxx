...
class VehicleContractorController extends Controller
{
    ...
    public function index(){
        ...
        $drivers = DriversModel::where("fk_contractor", $contractor->id)->where("fk_vehicle_state", "1")->get();
        
        return view('vehicles_contractor/lista', [
            "vehicles" => $vehicles,
    ...
    public function addDriver(Request $request){
        ...
        return redirect()->route('vehicles_contractor.index')->with('message', 'Driver has been successfully assigned');
    }

    public function createForm(){        
        $contractor = Auth::user()->contractor;
        return view('vehicles_contractor/create', [
            "contractor" => $contractor
        ]);
    }
    ...
    public function create(CreateRequest $request){
       ...
       /* if((!$request->hasFile("photo_truck_dot_inspection") && !$request->has("photo_truck_dot_inspection_box_data")) ||
        ...
        $vehicle->fk_contractor = $contractor->id;
        ...
        return redirect()->route('vehicles_contractor.index')->with('message', 'Vehicle created successfully!');
    }
    ...
    public function delete($id){
        ...
        return redirect()->route('vehicles_contractor.index')->with('message', 'Vehicle deleted successfully!');
    }
    ...
    public function editForm($id){
        ...
        return view('vehicles_contractor/edit', [
            "vehicle" => $vehicle,
            "contractor" => $contractor
        ]);
    }
    ...
    public function update($id, CreateRequest $request){
        ...
        return redirect()->route('vehicles_contractor.index')->with('message', 'Vehicle modified successfully!');
    }
}
