...
class DriversController extends Controller
{
    ...
    public function create($idContractor, CreateRequest $request){        
        ...
        $driver->fk_contractor = $idContractor;
        ...
        return redirect()->route('drivers.index',["id" => $idContractor])->with('message', 'Driver created successfully!');
    }
    ...
    public function delete($id){
        ...
        $driver->save();
        $idContractor = $driver->fk_contractor;
        
        return redirect()->route('drivers.index',["id" => $idContractor])->with('message', 'Driver deleted successfully!');
    }
    ...
    public function update($id, CreateRequest $request){
        ...
        return redirect()->route('drivers.index',["id" => $driver->fk_contractor])->with('message', 'Driver modified successfully!');
    }
}
