...
use App\Http\Requests\DeductionContractor\CreateRequest;
...
class DeductionsContractorController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $deductions = DeductionsModel::whereIn("fk_deduction_state",["1","2"])->where("fk_contractor","=",$contractor->id);
        ...
        return view('deductions_contractor/lista', [
    ...
    public function createForm(){
        ...
        if(isset($errors)){
            ...
            $vehicles = VehiclesModel::where("fk_contractor","=",$contractor->id)->get();
        }
        
        return view('deductions_contractor/create', [
            "deduction_types" => $deduction_types,
    ...
    public function create(CreateRequest $request){
        ...
        if($request->input("deduction_type") == "1"){
            ...
            $deduccion->fk_contractor = $contractor->id;
            $deduccion->save();
            ...
            for ($i=1; $i <= $request->input("vehicles"); $i++) {
                ...
                $arrInt = array();
                $vehicles = VehiclesModel::where("unit_number","=",$request->input('vehicle_'.$i))
                ->where("fk_contractor","=",$contractor->id)->first();
                if(!isset($vehicles)){
                    $vehicles = VehiclesModel::select("vehicles.*")
                    ->join("vehicles_alias as va", "va.fk_vehicle", "vehicles.id")
                    ->where("va.alias","=",$request->input('vehicle_'.$i))
        ...
        return redirect()->route('deductions_contractor.index')->with('message', 'Deduction created successfully!');
    }
    ...
    public function delete($id){
        ...
        return redirect()->route('deductions_contractor.index')->with('message', 'Deduction deleted successfully!');
    ...
    public function details($id){
        ...
        $html = view('deductions_contractor/ajax/details', ["deductions" => $deductions])->render();
        return response()->json([
            "success" => true,
            "html" => $html
        ]);
