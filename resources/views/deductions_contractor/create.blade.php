...
<div class="container-fluid min-h-100-vh">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('deductions_contractor.index')}}">Deductions</a></li>
            <li class="breadcrumb-item active" aria-current="page">Create</li>
        </ol>
    </nav>
    <div class="form-content">
        <form method="POST" action="{{ route('deductions_contractor.create') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
