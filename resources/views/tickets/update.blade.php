...
<div class="container-fluid min-h-100-vh">
    ...
    <div class="form-content">
        <form method="POST" action="{{ route('tickets.update', ['id' => $dataTicket->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off"  type="date" class="form-control @error('date_gen') is-invalid @enderror" id="date_gen" name="date_gen" placeholder="Date" value="{{ $dataTicket->date_gen }}" required>
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off"  type="text" class="form-control @error('number') is-invalid @enderror" id="number" name="number" placeholder="Number ticket" value="{{ $dataTicket->number }}" required>
                    ...
                    <div class="form-floating">
                        <select class="form-control form-select @error('contractor') is-invalid @enderror" id="contractor" name="contractor" >
                            ...
                            @foreach ($contractors as $contractor)
                                <option value="{{$contractor->id}}" @if ($dataTicket->vehicle->fk_contractor == $contractor->id)
                                    selected
                    ...
                    <div class="form-floating">
                        <select required class="form-control form-select @error('vehicle') is-invalid @enderror" id="vehicle" name="vehicle" >
                            ...
                            @foreach ($vehicles as $vehicle)
                                <option value="{{$vehicle->id}}" @if ($dataTicket->vehicle->id == $vehicle->id)
                                    selected
                    ...
                    <div class="form-floating">
                        <select class="form-control form-select @error('pickup') is-invalid @enderror" id="pickup" name="pickup" >
                            ...
                            @foreach ($pickups as $pickup)
                                <option value="{{$pickup->id}}" @if ($dataTicket->pickup == $pickup->place)
                                    selected
                    ...
                    <div class="form-floating">
                        <select class="form-control form-select @error('deliver') is-invalid @enderror" id="deliver" name="deliver" >
                            ...
                            @foreach ($delivers as $deliver)
                                <option value="{{$deliver->id}}" @if ($dataTicket->deliver == $deliver->place)
                                    selected
                        ...
                        <select class="form-control form-select select-with-other @error('material') is-invalid @enderror" 
                         ...
                         id="material" name="material" required>
                            ...
                            @foreach ($materials as $material) 
                                <option value="{{$material->id}}" @if ($dataTicket->fk_material == $material->id) selected @endif>{{$material->name}}</option>    
                            @endforeach
                        </select>
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off" type="text" class="form-control decimal @error('tonage') is-invalid @enderror" id="tonage" name="tonage" value="{{ $dataTicket->tonage }}" placeholder="Tonage" required>
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off"  type="text" class="form-control currency @error('rate') is-invalid @enderror" id="rate" name="rate" value="{{ $dataTicket->rate }}" placeholder="Rate" required>
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off"  type="text" class="form-control currency @error('total') is-invalid @enderror" id="total" name="total" value="{{ $dataTicket->total }}" placeholder="Total" required>
            ...
            <div class="row">               
                <div class="col-12 preview">
                    ...
                    @if(!is_null($dataTicket->file) && !empty($dataTicket->file))
                        <img src="{{ 
                            asset(str_replace('public','storage', $dataTicket->file)) 
                        }}" id="preview" />
                    @elseif(is_null($dataTicket->file) || empty($dataTicket->file))
            ...
            <footer class="form-group">
                <div class="text-center">
                    {{--  Id del ticket   --}}
                    <input autocomplete="off"  type="hidden" class="form-control currency" id="tikcetId" name="tikcetId" data-infoticket="{{ $dataTicket->vehicle->id }}" value="{{ $dataTicket->id }}" >
                    <button type="submit" class="btn btn-verde2">Update ticket</button>
                </div>
            </footer>
