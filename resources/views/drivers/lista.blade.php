...
<div class="container-fluid">    
    <div class="row align-items-center">
        ...
        <div class="col-2"></div>
        <div class="col-2">
            @if(in_array(17, $menu_user))
                <a href="{{route('drivers.create', ['id' => $contractor->id])}}" class="btn btn-verde2">Create Driver</a>
            @endif
        </div>
    </div>   
    @if (session('message'))
                    ...
                    @foreach ($drivers as $driver)
                        ...
                        <tr class="@if(sizeof($driver->vehicles) == 0) red-row @else gray-row @endif">
                            ...
                            <td class="text-center cont-icons">
                                ...
                                @endif
                                @if(in_array(18, $menu_user))
                                <a href="{{route('drivers.edit', ['id' => $driver->id])}}" class="edit" data-toggle="tooltip" data-placement="left" title="Edit">
                                    <img src="{{ asset('imgs/ico_edit.png')}}" />
                                </a>
                                @endif
                                @if(in_array(19, $menu_user))
                                <a href="{{route('drivers.delete', ['id' => $driver->id])}}" class="delete"  data-toggle="tooltip" data-placement="left" title="Delete">
