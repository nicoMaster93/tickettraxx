...
<div class="container-fluid min-h-100-vh">
    ...
    <div class="form-content">
        <form method="POST" action="{{ route('tickets_contractor.create') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off" readonly type="text" class="form-control currency @error('rate') is-invalid @enderror" id="rate" name="rate" value="{{ old('rate') }}" placeholder="Rate" required>
