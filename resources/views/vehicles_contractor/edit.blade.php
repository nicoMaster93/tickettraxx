...
<div class="container-fluid min-h-100-vh">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('vehicles_contractor.index')}}">Vehicles</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit</li>
        </ol>
    </nav>
    <div class="form-content">
        <form method="POST" action="{{ route('vehicles_contractor.edit', ['id' => $vehicle->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row" id="cont_alias">
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('unit_number') is-invalid @enderror" id="unit_number" name="unit_number" placeholder="Name" value="{{ old('unit_number', $vehicle->unit_number) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-center">
                            <input type="text" class="form-control" name="num_alias" id="num_alias" value="{{ old('num_alias', sizeof($vehicle->alias)) }}" />
                        </div>
                        <div class="col-md-2 text-center">
                ...
                @for ($i = 1; $i <= intval(old('num_alias', sizeof($vehicle->alias))); $i++)
                    <div class="col-md-3 alias">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('alias_'.$i) is-invalid @enderror" id="alias_{{$i}}" name="alias_{{$i}}" placeholder="Alias {{$i}}" value="{{ old('alias_'.$i,$vehicle->alias[$i-1]->alias) }}" required>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('truck_model_brand') is-invalid @enderror" id="truck_model_brand" name="truck_model_brand" placeholder="Model Brand" value="{{ old('truck_model_brand', $vehicle->truck_model_brand) }}" >
                ...
                <div class="col-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('truck_year') is-invalid @enderror" id="truck_year" name="truck_year" placeholder="Year" value="{{ old('truck_year', $vehicle->truck_year) }}" >
                ...
                <div class="col-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('truck_vin_number') is-invalid @enderror" id="truck_vin_number" name="truck_vin_number" placeholder="Truck VIN Number" value="{{ old('truck_vin_number', $vehicle->truck_vin_number) }}" >
            ...
            <div class="row">               
                <div class="col-12 preview">
                    ...
                    <img @if(Storage::disk('local')->exists($vehicle->photo_truck_dot_inspection))
                            src="{{Storage::url($vehicle->photo_truck_dot_inspection)}}"
                         @else
                            src="/imgs/theme/no-image.png"
                         @endif id="preview_truck_dot_inspection" />
                </div>
            ...
            <div class="row">               
                <div class="col-12 preview">
                    ...
                    <img @if(Storage::disk('local')->exists($vehicle->photo_truck_registration))
                            src="{{Storage::url($vehicle->photo_truck_registration)}}"
                         @else
                            src="/imgs/theme/no-image.png"
                         @endif id="preview_truck_registration" />
                </div>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('trailer_model_brand') is-invalid @enderror" id="trailer_model_brand" name="trailer_model_brand" placeholder="Model Brand" value="{{ old('trailer_model_brand', $vehicle->trailer_model_brand) }}" >
                ...
                <div class="col-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('trailer_year') is-invalid @enderror" id="trailer_year" name="trailer_year" placeholder="Year" value="{{ old('trailer_year', $vehicle->trailer_year) }}" >
                ...
                <div class="col-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('trailer_vin_number') is-invalid @enderror" id="trailer_vin_number" name="trailer_vin_number" placeholder="Trailer VIN Number" value="{{ old('trailer_vin_number', $vehicle->trailer_vin_number) }}" >
            ...
            <div class="row">               
                <div class="col-12 preview">
                    ...
                    <img @if(Storage::disk('local')->exists($vehicle->photo_trailer_dot_inspection))
                            src="{{Storage::url($vehicle->photo_trailer_dot_inspection)}}"
                         @else
                            src="/imgs/theme/no-image.png"
                         @endif id="preview_trailer_dot_inspection" />
                </div>
            ...
            <div class="row">               
                <div class="col-12 preview">
                    ...
                    <img @if(Storage::disk('local')->exists($vehicle->photo_trailer_registration))
                            src="{{Storage::url($vehicle->photo_trailer_registration)}}"
                         @else
                            src="/imgs/theme/no-image.png"
                         @endif  id="preview_trailer_registration" />
                </div>
            ...
            <div class="row">               
                <div class="col-12 preview">
                    ...
                    <img @if(Storage::disk('local')->exists($vehicle->photo_trailer_over))
                            src="{{Storage::url($vehicle->photo_trailer_over)}}"
                         @else
                            src="/imgs/theme/no-image.png"
                         @endif id="preview_trailer_over" />
                </div>
